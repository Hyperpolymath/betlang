...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*A ternary probabilistic programming language for modeling uncertainty*")
...
(define development-practices
  '((code-style
     (languages . ("CSS" "HTML" "Just" "Racket" "Scheme"))
...
(cross-platform-status
  ...
  (gitlab-mirror
    (path "hyperpolymath/betlang")
    (url "https://gitlab.com/hyperpolymath/betlang")
  ...
  (reconciliation-instructions
    ...
    ";; git remote add gitlab https://gitlab.com/hyperpolymath/betlang.git"
    ";; git fetch gitlab"
    ";;"

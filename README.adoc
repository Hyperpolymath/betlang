...
:experimental:
:url-github: https://github.com/hyperpolymath/betlang
:url-gitlab: https://gitlab.com/hyperpolymath/betlang
:url-bitbucket: https://bitbucket.org/hyperpolymath/betlang
:url-codeberg: https://codeberg.org/hyperpolymath/betlang

Betting and odds calculation domain-specific language
...
betlang is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.

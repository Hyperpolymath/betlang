...
*Source Text:* This paper formalizes the language semantics, establishes
its mathematical foundations

*Target Text:* key correctness properties, and demonstrates its
expressiveness for statistical computation, Bayesian inference, and

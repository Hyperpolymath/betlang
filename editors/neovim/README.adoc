...
Copy the contents of this directory to: - Neovim:
`+~/.config/nvim/pack/plugins/start/betlang/+` - Vim:
`+~/.vim/pack/plugins/start/betlang/+`
...
* https://github.com/neovim/nvim-lspconfig[nvim-lspconfig] (for LSP
support)
